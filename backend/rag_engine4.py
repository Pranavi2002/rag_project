...
- No Strict Grounding Prompt: low ragas faithfulness score because the answer has no prompting instructions and maybe hallucinated
"""
...
def query_rag(question: str, k: int = 3, mode: str = "auto"):
    ...
    # Step 5: Construct prompts for full and summary answers.
    normal_prompt = f"""
