...
- Soft Grounding Prompt: good ragas faithfulness score with good ragas contextual recall and good deepeval context relevancy scores
"""
...
def query_rag(question: str, k: int = 3, mode: str = "auto"):
    ...
    normal_prompt = f"""
    You are an AI assistant. Answer the question based on the retrieved context below.
    You may paraphrase, summarize, or reword the information, but do not include any information or examples that are unrelated to the context.
    If the context does not contain enough information to answer the question, say "The context does not provide that information."
    ...
    summary_prompt = f"""
    Write a short summary (1-2 sentences) based on the provided context.
    You may paraphrase or summarize, but do not add information not present in the context.
